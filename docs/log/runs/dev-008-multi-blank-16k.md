...
- **Budget forcing:** [dev-010-bf](dev-010-bf-budget-forcing.md) — FF-biased `Wait` + baseline prompt; **identical** metrics on same 112-row slice (no incremental lift vs multi_blank).
