...
- **Required base model:** To enforce fairness, final responses must be generated by **`Qwen/Qwen3-4B-Thinking-2507`** only — no alternative base models. You may fine-tune this checkpoint with your proposed methods (e.g. LoRA/QLoRA SFT); the graded submission path must still use this model family for inference.
